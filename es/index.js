...
module.exports = function () {
    function Referer(ref, opts) {
        _classCallCheck(this, Referer);
        ...
        if (res.type) {
            this.refferal.type = res.type;
        }
        if (res.name) {
            this.refferal.name = res.name;
        }
        if (res.search) {
            this.refferal.search = res.search;
        }
        if (data.host) {
            this.refferal.host = data.host;
        }
        if (res.page) {
            this.refferal.page = res.page;
        }
    }

    Referer.prototype.searcher = function searcher(data) {
    ...
    Referer.prototype.puller = function puller(result, data) {
    ...
    Referer.prototype.internal = function internal(result, data) {
        //get site name
